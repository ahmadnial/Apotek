        ...
        <form action="" method="POST">
            ...
            <div style="overflow-x:auto;">
                <table class="table table-bordered" id="dynamicTable">
                    ...
                    <tr>
                        <td><input type="text" name="addmore[0][kd_barang]" placeholder="Enter your Name"
                                class="form-control" />
                        </td>
                        <td>
                            <select class="select_nm_brg form-control" name="addmore[0][Nama_Barang]" id="">
                                <option value="">tes</option>
                                <option value="">tes</option>
                                <option value="">tes</option>
                                <option value="">tes</option>
                            </select>
                            {{-- <input type="text" name="addmore[0][Nama_Barang]" placeholder="Enter your Qty"
                                class="form-control" /> --}}
                        </td>
                        ...
                        <td><input type="text" name="addmore[0][qty]" placeholder="Enter your Price"
                                class="form-control" /></td>
                        <td><input type="text" name="addmore[0][harga_satuan]" placeholder="Enter your Price"
                                class="form-control" /></td>
                        <td><input type="text" name="addmore[0][jumlah]" readonly class="form-control" /></td>
                    ...
                    {{-- <tr> --}}
                        ...
                        <td><input type="text" value="" name="" placeholder="Enter your Qty" class="form-control" />
                        </td>
                        <td><input type="text" value="" name="" placeholder="Enter your Price" class="form-control" />
                        </td>
