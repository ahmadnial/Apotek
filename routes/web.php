...
use App\Http\Controllers\distriController;
...
Route::group(['middleware' => 'auth'], function () {
     ...
     * Add Distributor
     */
    Route::get('disrtibutor', 'distriController@index')->name('distributor');
    Route::post('/addDistributor', [distriController::class, 'store'])->name('addDistributor');

    /*
     * Add Pembelian Barang
     */
    Route::get('Pembelian', 'addController@index')->name('Pembelian');
    Route::post('/addPembelian', [addController::class, 'store'])->name('addPembelian');
});
